              ...
              <div class="tile is-parent is-vertical">
                <article class="tile is-child">
                  <figure class="media-left">
                      <img class="is-rounded" style="width:320px;height:320px;border-radius: 100%;" 
                        src="https://github.com/eric9991517/eric9991517/blob/main/yiyi.jpg?raw=true">
                  </figure>
                </article>
              </div>
              ...
              <div class="tile is-parent">
                <article class="tile is-child">
                  ...
                  <p class="subtitle">
                    ...
                    <!--github link-->
                    <a href="https://github.com/eric9991517">
                      <span class="icon has-text-info">
                    ...
                    <!--Linkedin link-->
                    <a href="https://www.linkedin.com/in/yiyi-chen-261aa1248/">
                      <span class="icon has-text-info">
                  ...
                  <p>Greeting my guest ! <br> I am Adam, a research assistant at the National <a href="https://academiasinicanlplab.github.io/">Academia Sinica</a>,  in Taiwan. I am studying in the institute of Biomedical Informatics in the National Yang Ming Chiao Tung University. My research focuses on natural language processing application and information retrieval in medical field. Being passionate about using NLP in solving practical problems, I also develope systems that utilize deep learning with my another domain knowledge in EMT. Recently, the research  on Emergency Medical Methods is what I am dedicated and  <strong> I am looking for an exchange oppotunity of Computer Science in Fall 2022! <br> </strong> Here is my <a style="color:#3298dc" href="https://Adam-Leon.github.io/"><span class="tag is-info is-light">CV</span></a></p> 
